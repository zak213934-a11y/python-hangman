...
reference. By default it targets ``HEAD`` and writes to ``releases/``
inside the project root, but you can override the location with
``--output-dir`` and choose any tag or branch via ``--ref``. It refuses to
